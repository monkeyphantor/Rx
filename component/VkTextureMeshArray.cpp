    ...
    namespace Component{
        void vkTextureMeshArray_component_on_add(flecs::entity e, TextureMeshArray& meshArray, VkTextureMeshArray& vkTextureMeshArray){
            ...
            Rx::Core::BufferInterface vertexInterface = 
                Rx::Core::createBufferInterface(totalVertices, sizeof(Rx::Vertex::Texture),
            ...
            vkTextureMeshArray.vertexBuffer = Rx::Core::createBuffer(totalVertices, sizeof(Rx::Vertex::Texture),
                VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_VERTEX_BUFFER_BIT);

            vkTextureMeshArray.indexBuffer = Rx::Core::createBuffer(totalIndices, sizeof(uint32_t),
            ...
            for (const auto& vertexArray : meshArray.vertexArrays)
            {
                size_t arraySize = vertexArray.size() * sizeof(Rx::Vertex::Texture);
            ...
            vertexCopy.size = totalVertices * sizeof(Rx::Vertex::Texture);
            ...
            RX_VK_MUTEX(
                ...
                vkCmdCopyBuffer(Rx::Core::singleCommand.vkCommandBuffer,
                    ...
                    vkTextureMeshArray.vertexBuffer.vkBuffer,
                    1, &vertexCopy);
                vkCmdCopyBuffer(Rx::Core::singleCommand.vkCommandBuffer,
                    indexInterface.vkBuffer,
                    vkTextureMeshArray.indexBuffer.vkBuffer,
                    1, &indexCopy);
        ...
        void vkTextureMeshArray_component_on_remove(flecs::entity e, VkTextureMeshArray& vkTextureMeshArray){
            // Destroy GPU buffers
            Rx::Core::destroyBuffer(vkTextureMeshArray.vertexBuffer);
            Rx::Core::destroyBuffer(vkTextureMeshArray.indexBuffer);
        }
